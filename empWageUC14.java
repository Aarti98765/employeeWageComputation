...
//CREATED CLASS EMPLOYEE WAGE 
public class empWageUC14 implements IempWageBuilder {
	...
	for ( companyEmpWage empObj : company) {
		...
		while (totalEmpHrs <= empObj.obtainMonthMaxHrs() && 
			...
			empWage = empHrs * empObj.obtainRateOfEmp();
			dailyWage.add(empWage);
			totalWage=totalWage+empWage;
	        }
                getTotalWage(totalWage);
	    }
	}
	public static void getTotalWage(int totalWage) {
		System.out.println("Company");
		System.out.println("Total wage of company:" + totalWage);
        }
	//MAIN DRIVER PROGRAM
   	public static void main(String args[]) {
   		empWageUC14 employee = new empWageUC14();
